...
// Pinned version — avoids picking up a broken CDN release automatically.
// Bump this intentionally when upgrading Supabase SDK.
const SDK_URL = 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.49.4/+esm';

// Module-level singleton — the same client instance is reused on every call
// within a single page load (ES modules are cached by the browser).
let _client = null;
